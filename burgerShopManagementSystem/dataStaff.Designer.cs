...
namespace burgerShopManagementSystem {
    ...
    public partial class dataStaff : global::System.Data.DataSet {
        ...
        public partial class StaffDataTable : global::System.Data.TypedTableBase<StaffRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StaffRow AddStaffRow(int Uid, string FirstName, string LastName, int CNumber, string dateOfBirth, string Job, string Address, string UName, int pw) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StaffRow FindByUid(int Uid) {
        ...
        public partial class StaffRow : global::System.Data.DataRow {
            ...
            public int Uid {
                get {
                    return ((int)(this[this.tableStaff.UidColumn]));
                }
                set {
...
namespace burgerShopManagementSystem.dataStaffTableAdapters {
    ...
    public partial class StaffTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Staff] ([Uid], [FirstName], [LastName], [CNumber], [dateOfBirth], [Job], [Address], [UName], [pw]) VALUES (@Uid, @FirstName, @LastName, @CNumber, @dateOfBirth, @Job, @Address, @UName, @pw);
SELECT Uid, FirstName, LastName, CNumber, dateOfBirth, Job, Address, UName, pw FROM Staff WHERE (Uid = @Uid)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Staff] SET [Uid] = @Uid, [FirstName] = @FirstName, [LastName] = @LastName, [CNumber] = @CNumber, [dateOfBirth] = @dateOfBirth, [Job] = @Job, [Address] = @Address, [UName] = @UName, [pw] = @pw WHERE (([Uid] = @Original_Uid) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([CNumber] = @Original_CNumber) AND ([dateOfBirth] = @Original_dateOfBirth) AND ([Job] = @Original_Job) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_UName = 1 AND [UName] IS NULL) OR ([UName] = @Original_UName)) AND ((@IsNull_pw = 1 AND [pw] IS NULL) OR ([pw] = @Original_pw)));
SELECT Uid, FirstName, LastName, CNumber, dateOfBirth, Job, Address, UName, pw FROM Staff WHERE (Uid = @Uid)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Uid, FirstName, LastName, CNumber, dateOfBirth, Job, Address, UName, pw FR" +
                "OM dbo.Staff";
        ...
        public virtual int Fill(dataStaff.StaffDataTable dataTable) {
        ...
        public virtual dataStaff.StaffDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dataStaff.StaffDataTable dataTable = new dataStaff.StaffDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dataStaff.StaffDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Uid, string Original_FirstName, string Original_LastName, int Original_CNumber, string Original_dateOfBirth, string Original_Job, string Original_Address, string Original_UName, global::System.Nullable<int> Original_pw) {
            ...
            this.Adapter.DeleteCommand.Parameters[3].Value = ((int)(Original_CNumber));
            ...
            if ((Original_UName == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[9].Value = ((string)(Original_UName));
            }
            if ((Original_pw.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[10].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[11].Value = ((int)(Original_pw.Value));
            }
            else {
        ...
        public virtual int Insert(int Uid, string FirstName, string LastName, int CNumber, string dateOfBirth, string Job, string Address, string UName, global::System.Nullable<int> pw) {
            ...
            if ((pw.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[8].Value = ((int)(pw.Value));
            }
            else {
        ...
        public virtual int Update(
            ...
            if ((UName == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(UName));
            }
            if ((pw.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(pw.Value));
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[12].Value = ((int)(Original_CNumber));
            if ((Original_dateOfBirth == null)) {
                throw new global::System.ArgumentNullException("Original_dateOfBirth");
            }
            else {
            ...
            if ((Original_pw.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[20].Value = ((int)(Original_pw.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    string Original_UName, 
                    global::System.Nullable<int> Original_pw) {
            return this.Update(Original_Uid, FirstName, LastName, CNumber, dateOfBirth, Job, Address, UName, pw, Original_Uid, Original_FirstName, Original_LastName, Original_CNumber, Original_dateOfBirth, Original_Job, Original_Address, Original_UName, Original_pw);
        }
    }
